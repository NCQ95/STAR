...
def set_dataloaders(
    ...
    output_names_val[0] = 'output-Img'
    output_names_val = [output_names_val[0]]
    return {
...
class ImageFolderPseudoDomains(tv.datasets.ImageFolder):
    def __init__(
        ...
        self.transforms[1] = self.transforms[0]
    ...
    def __getitem__(self, index):
        ...
        current_roots[1] = './data/PACS/PACS_Original'
        if self.is_for_test == True:
            current_roots = [current_roots[1]]
